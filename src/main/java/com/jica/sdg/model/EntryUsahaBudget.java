...
@Entity
@Table(name = "entry_usaha_budget")
public class EntryUsahaBudget implements Serializable {
    ...
    @Column(name = "id_usaha_activity")
    private Integer id_usaha_activity;
    ...
    public EntryUsahaBudget() {
    }

    public EntryUsahaBudget(Integer id, Integer id_usaha_activity, Integer achievement1, Integer achievement2, Integer achievement3, Integer achievement4, Integer new_value1, Integer new_value2, Integer new_value3, Integer new_value4, Integer year_entry, Integer id_role, Integer created_by, Integer created_by2, Integer created_by3, Integer created_by4, Date date_created, Date date_created2, Date date_created3, Date date_created4, Integer id_monper) {
        this.id                 = id;
        this.id_usaha_activity    = id_usaha_activity;
...
//        this.show_report_date   = show_report_date;
    ...
    public Integer getId_usaha_activity() {
        return id_usaha_activity;
    }

    public void setId_usaha_activity(Integer id_usaha_activity) {
        this.id_usaha_activity = id_usaha_activity;
    }
