...
@Entity
@Table(name = "usaha_collaboration")
public class UsahaCollaboration implements Serializable {
    ...
    public UsahaCollaboration() {
    }

    public UsahaCollaboration(Integer id, String sector, String id_program, String location, String beneficiaries, String ex_benefit, String type_support, Integer id_philanthropy) {
        this.id             = id;
        this.sector         = sector;
