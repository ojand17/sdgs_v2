...
@Entity
@Table(name = "entry_gov_budget")
public class EntryGovBudget implements Serializable {
    ...
    @Column(name = "id_gov_activity")
    private Integer id_gov_activity;
    ...
    public EntryGovBudget() {
    }

    public EntryGovBudget(Integer id, Integer id_gov_activity, Integer achievement1, Integer achievement2, Integer achievement3, Integer achievement4, Integer new_value1, Integer new_value2, Integer new_value3, Integer new_value4, Integer year_entry, Integer id_role, Integer created_by, Integer created_by2, Integer created_by3, Integer created_by4, Date date_created, Date date_created2, Date date_created3, Date date_created4, Integer id_monper) {
        this.id                 = id;
        this.id_gov_activity    = id_gov_activity;
...
//        this.show_report_date   = show_report_date;
    ...
    public Integer getId_gov_activity() {
        return id_gov_activity;
    }

    public void setId_gov_activity(Integer id_gov_activity) {
        this.id_gov_activity = id_gov_activity;
    }
