...
@Entity
@Table(name = "usaha_activity")
public class UsahaActivity implements Serializable {
	...
	public UsahaActivity() {
	}

	public UsahaActivity(Integer id, String id_activity, String id_program, Integer id_role, String nm_activity,
