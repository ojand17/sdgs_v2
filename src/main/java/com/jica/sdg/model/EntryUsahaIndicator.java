...
@Entity
@Table(name = "entry_usaha_indicator")
public class EntryUsahaIndicator implements Serializable {
...
//        this.show_report_date   = show_report_date;
    ...
    public Integer getId_assign() {
        return id_assign;
    }

    public void setId_assign(Integer id_assign) {
        this.id_assign = id_assign;
    }
