...
@Entity
@Table(name = "entry_sdg_detail")
public class EntrySdgDetail implements Serializable {
    ...
    @Column(name = "id_disaggre")
    private Integer id_disaggre;
    
    @Column(name = "id_disaggre_detail")
    private Integer id_disaggre_detail;
    ...
    public EntrySdgDetail() {
    }

	public EntrySdgDetail(Integer id, Integer id_disaggre, Integer id_disaggre_detail, Integer achievement1,
			Integer achievement2, Integer achievement3, Integer achievement4, Integer new_value1, Integer new_value2,
			Integer new_value3, Integer new_value4, Integer year_entry, Integer id_role, Integer created_by,
			Date date_created, Integer id_monper) {
		super();
		this.id = id;
		this.id_disaggre = id_disaggre;
		this.id_disaggre_detail = id_disaggre_detail;
	...
	public Integer getId_disaggre_detail() {
		return id_disaggre_detail;
	}

	public void setId_disaggre_detail(Integer id_disaggre_detail) {
		this.id_disaggre_detail = id_disaggre_detail;
	}
